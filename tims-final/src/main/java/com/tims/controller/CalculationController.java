...
public class CalculationController {
    ...
    public ResponseEntity<List<CalculationResponse>> getHistory(@PathVariable Short tankId) {
    ...
    public ResponseEntity<CorrosionOverride> applyOverride(
            @Valid @RequestBody OverrideRequest req) {
        return ResponseEntity.ok(calculationService.applyOverride(req));
    }
}
